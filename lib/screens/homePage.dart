...
import 'package:weather_demo/models/weather.api.dart';
import 'package:weather_demo/models/weather.dart';
import 'package:weather_demo/models/weather2.api.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  void getIP() async {
    await Ipify.ipv4().then((value) {
      debugPrint("city:"+value.toString());
      getWeather("Dhaka"); //! if you want to change the city, for example to Katowice you can replace the value with 'Katowice', value is client IP city
      getWeather2("Dhaka"); //! same as above
    });
  }
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: InputDecoration(// Added this
                  ...
                  suffixIcon: cityTextController.text.isNotEmpty?IconButton(
                      icon: const Icon(Icons.clear),
                      onPressed: ()=>cityTextController.clear()
                  ):const Text('')
              ),
          ...
          Row(
            ...
            children: [
              ...
              ElevatedButton(
                  ...
                  onPressed: () {
                    setState(() {
                      getWeather(cityTextController.text);
                      getWeather(cityTextController.text);
